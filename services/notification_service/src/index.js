...
const kafkaNotificationService = require('./services/kafkaNotificationService');
...
const StartServer = async() => {
    ...
    try {
        ...
        await kafkaNotificationService.startConsumer();
        ...
        process.on('SIGINT', async () => {
            ...
            await kafkaNotificationService.stopConsumer();
            server.close(() => {
