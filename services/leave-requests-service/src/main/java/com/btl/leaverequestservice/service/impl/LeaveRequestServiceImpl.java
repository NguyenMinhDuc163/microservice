...
public class LeaveRequestServiceImpl implements LeaveRequestService {
    ...
    public LeaveRequest createLeaveRequest(LeaveRequest request) {
        ...
        EmployeeDTO employee = employeeServiceClient.getEmployee(request.getEmployeeId()).getData();
        ...
        LeaveValidationResponse validationResponse = leaveServiceClient.validateLeaveRequest(validationRequest).getData();
